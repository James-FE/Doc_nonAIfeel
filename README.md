# Humanizer-zh: AI 写作去痕工具（个人维护中文版）
...
Humanizer-zh 是一个个人维护的中文 humanizer skill，用于去除文本中的 AI 生成痕迹，帮助你将 AI 生成的内容改写得更自然、更像人类书写的文本。除了单段中的套话、排比和 AI 词汇，它也关注长文档里的跨段重复、机械分点、相邻段落同构和术语口号化重复。
